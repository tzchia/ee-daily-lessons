...
2a. 白話優先（學員回饋 2026-07-25）：每個學術段落（頻譜、推導、統計等）前面必須先有一段「白話版」生活比喻卡（card intuition），讓完全不懂數學的人也能抓到結論；數學式後面附一句「白話翻譯」；專有名詞第一次出現要用一句生活化的話解釋；明確告訴學員「公式看不懂可以先跳過，懂結論就好」。判斷標準：把所有公式遮住，只讀白話部分仍能完整理解今天在講什麼
